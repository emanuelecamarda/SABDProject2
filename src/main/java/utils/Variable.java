...
public class Variable {
    ...
    public static final String  FILE                        = "/data/Comments_jan-apr2018.csv";
    ...
    public static final String RABBITMQ_USER                = "rabbitmq";
    public static final String RABBITMQ_PASS                = "rabbitmq";
    ...
    public static final String OUTPUT_FILE_Q1_1HOUR         = ".../outputQ1_1Hour.csv";
